frappe.pages['worksite-structure-tree'].on_page_load = function(wrapper) {
...
function initializeChart() {
	frappe.xcall("go1_enterprise_structure.go1_enterprise_structure.page.worksite_structure_tree.worksite_structure_tree.get_organisation_data")
		.then((r) => {
			var chart ;
			var dataFlattened = r;
